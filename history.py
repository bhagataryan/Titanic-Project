...
## ---(Tue Dec 31 11:13:03 2024)---
import pandas as pd
titanic = pd.read_csv(r"C:\Users\DRYDEN\Downloads\24th,26th - ML_ data preprocessing pipeline\24th- ML\TITANIC PROJECT\DATASET\titanic dataset.csv")
titanic.tail()
titanic.describe()
del titanic["Name"]
titanic.head()
%runcell -i 0 C:/Users/DRYDEN/.spyder-py3/temp.py
del titanic["Ticket"]
titanic.head()
del titanic["Fare"]
titanic.head()
...
plt.pie(p,    #giving array
       labels = ['Male', 'Female'], #Correspndingly giving labels
       colors = ['green', 'yellow'],   # Corresponding colors
       explode = (0.30, 0),    #How much the gap should me there between the pies
       startangle = 0)  #what start angle should be given
plt.axis('equal') 
plt.show()
...
plt.pie(p,    #giving array
       labels = ['Male', 'Female'], #Correspndingly giving labels
       colors = ['green', 'yellow'],   # Corresponding colors
       explode = (0.30, 1),    #How much the gap should me there between the pies
       startangle = 0)  #what start angle should be given
plt.axis('equal') 
plt.show()
...
plt.pie(p,    #giving array
       ...
       colors = ['green', 'yellow'],   # Corresponding colors
       explode = (0.10, 0),    #How much the gap should me there between the pies
       startangle = 45)  #what start angle should be given
plt.axis('equal') 
plt.show()
